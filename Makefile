...
#    Updated: 2024/11/18 13:23:46 by Furaido          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = main.c get_next_line.c read_map.c enemy00.c enemy01.c player00.c \
		render_map.c validate_map.c player01.c gold_rush.c position.c textures00.c \
		window.c
OBJS = $(SRCS:.c=.o)
